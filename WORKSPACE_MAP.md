...
- **Stack**: React 19, Vite 6, Tailwind CSS 3, Lucide React.
...
- **Stack**: React 19, Vite 6, Google Gemini 1.5 Flash, @xyflow/react, Firestore.
...
### Technical Standards
- **Modern React**: Standardization on React 19 and Vite 6 for all web-based agents.
