...
- [ ] **Unified Versioning**: Ensure the project version (currently `v2026.6.12`) is consistent across `package.json`, `metadata.json`, `index.html`, `src/App.jsx` (test hooks), and `src/components/Layout/Footer.jsx`.
...
- [ ] **Dynamic Experience**: Link the "14+ years" experience string to a central constant in `src/constants/data.js` or `metadata.json`.
