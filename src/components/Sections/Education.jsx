...
export default function Education() {
  return (
    <section
      ...
      className="py-24 bg-white dark:bg-slate-900 min-h-[600px] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="space-y-10">
          {degrees.map((edu, i) => (
            <div
              key={i}
              className="group bg-gradient-to-r from-slate-50 to-white dark:from-slate-800/50 dark:to-slate-900 rounded-[2.5rem] p-10 border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-[#00685f]/5 transition-all duration-500"
            >
              <div className="flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1 text-center md:text-left">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                    <h3 className="text-2xl font-black font-headline tracking-tight text-slate-800 dark:text-white leading-tight">
                      {edu.degree}
                    </h3>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-4 text-lg">
                    <p className="text-[#00685f] dark:text-[#6bd8cb] font-extrabold italic">
                      {edu.school}
                    </p>
                    <span className="hidden md:block w-1.5 h-1.5 rounded-full bg-slate-300 dark:bg-slate-700"></span>
                    <p className="text-slate-400 dark:text-slate-500 font-bold text-sm tracking-wide uppercase">
                      {edu.location}
                    </p>
                  </div>
                </div>
