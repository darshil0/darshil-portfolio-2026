...
export default function About() {
  return (
    <section
      id="about-section"
      className="py-24 bg-[#eef4ff] dark:bg-slate-900/50 min-h-[600px] relative overflow-hidden"
    >
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-8 space-y-8">
            <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-10 shadow-2xl border border-slate-100 dark:border-slate-800 transition-all duration-500 hover:shadow-cyan-900/5">
              ...
              <div className="space-y-6 text-slate-600 dark:text-slate-300 text-lg leading-relaxed">
                <p>
                  I lead QA teams that do far more than find bugs — we prevent
                  patient safety risks, drive measurable business impact, and
                  enable safer, smarter healthcare innovation.
                </p>
                <p>
                  At Accenture, I transformed QA delivery for Fortune 500
                  healthcare clients, earning awards for leadership and
                  technical excellence. My approach: empathy, integrity, and
                  transparent communication.
                </p>
              </div>

              <div className="mt-12 pt-10 border-t border-slate-100 dark:border-slate-800">
                <h4 className="font-black text-xs uppercase tracking-[0.3em] text-[#00685f]/60 dark:text-[#6bd8cb]/60 mb-8">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div
                      key={s}
                      className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-800/50 p-3 rounded-xl border border-transparent hover:border-[#00685f]/20 transition-all"
                    >
                      <div className="w-6 h-6 rounded-full bg-[#00685f]/10 flex items-center justify-center shrink-0">
                        <Check
                          size={12}
                          className="text-[#00685f] dark:text-[#6bd8cb]"
                        />
                      </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-10 shadow-xl border border-slate-100 dark:border-slate-800">
              <h4 className="font-black text-xs uppercase tracking-[0.3em] text-[#00685f]/60 dark:text-[#6bd8cb]/60 mb-6">
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <div
                    key={lang}
                    className="px-5 py-3 bg-[#eef4ff] dark:bg-slate-800 text-[#00685f] dark:text-[#6bd8cb] rounded-2xl text-xs font-bold border border-[#00685f]/5 shadow-sm"
                  >
                    {lang}
                  </div>
                ))}
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-gradient-to-br from-[#121c28] to-[#00201d] rounded-[2rem] p-10 text-white shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-sm text-[#89f5e7] font-bold uppercase tracking-widest mb-10 opacity-80">
                Global QA Leader
              </p>
              <ul className="space-y-6">
                {[
                  "US Citizen",
                  `${experienceYears} Leading QA`,
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-10 shadow-xl border border-slate-100 dark:border-slate-800">
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <div
                    key={skill}
                    className="group flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl hover:bg-[#00685f] dark:hover:bg-[#00685f] transition-all duration-300"
                  >
                    <span className="text-xs font-bold text-slate-700 dark:text-slate-300 group-hover:text-white transition-colors">
                      {skill}
                    </span>
